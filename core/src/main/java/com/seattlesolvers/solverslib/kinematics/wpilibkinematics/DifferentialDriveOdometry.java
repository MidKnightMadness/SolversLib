 ...
 *
 * <p>It is important that you reset your encoders to reset before using this class.
 * Any subsequent pose resets also require the encoders to be reset to reset.
 */
public class DifferentialDriveOdometry {
     ...
     *
     * <p>You NEED to reset your encoders (to reset) when calling this method.
     *
